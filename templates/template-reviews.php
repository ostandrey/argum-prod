...
$reviews_hero_title = get_field('reviews_hero_title');
$reviews_hero_image = get_field('reviews_hero_image');

$reviews_hero_title_field = get_field('reviews_hero_title_field');
$reviews_hero_field = get_field('reviews_hero_field');
...
<main>
    <section class="w-100 hero d-flex justify-content-center align-items-center <?= $module_class ?>" id="<?= $module_id ?>">
        ...
        if ($reviews_hero_field) { ?>
            <h1 class="hero__title text-center align-middle"><?php echo $reviews_hero_title; ?></h1>
        <?php } ?>
